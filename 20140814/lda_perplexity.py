...
def graph_draw(topic,perplexity):
	...
	plt.xlabel("Number of Topic",color='black')
	plt.ylabel("Perplexity",color='black')
	plt.show()


topic=[]
perplexity_list=[]
f1=open('/home/alber/NLP/20140814/lda/test.txt','r')
testset=f1.read()
...
for i in list(range(19)):
	dictionary={}
	iteration=(10*i+20)			#迭代文件名设置
	topic.append(iteration)
	trace="/home/alber/NLP/20140814/lda/tplink/diff-topic/model-"+str(iteration)+".txt"
	f=open(trace,'r')
	text=f.readlines()
	word_list=[]
	for line in text:
