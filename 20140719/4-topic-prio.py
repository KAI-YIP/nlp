...
t1=time.time()
f1=open("/home/alber/experiment/20140719/prio_result1.txt",'r')
...
print (topic)
f2=open("/home/alber/experiment/20140719/dell_result0.txt",'r')
...
for line in target_txt:
	...
	document.extend('\n')
print (len(document))
f3=open("/home/alber/experiment/20140719/dell_result1.txt",'a')
